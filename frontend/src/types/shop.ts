...
export type CustomerSupportReply = { conversation_id:number; answer:string; intent:string; evidence:{products?:{product_id:number; product_name?:string; source_url:string}[]; order_id?:number} }
