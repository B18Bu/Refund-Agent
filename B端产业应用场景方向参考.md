[https://github.com/datawhalechina/easy-vibe/blob/v0.3.0/docs/zh-cn/stage-1/appendix-industry-scenarios/index.md](https://github.com/datawhalechina/easy-vibe/blob/v0.3.0/docs/zh-cn/stage-1/appendix-industry-scenarios/index.md)
...
# B 端产业应用场景方向参考
## 章节导读
 本文档汇总了 **LLM 大模型在 B 端企业场景中的落地应用**。与 C 端关注用户体验和情感不同，B 端产品更注重**解决实际业务需求、提升效率、降低成本**。每个场景都具备**实际落地的可行性**，涵盖从**需求分析到技术实现**的完整思路，适合面向企业客户的 AI 应用开发者参考。 

## 行业方向快速选择
**找到适合你的应用场景**

<font style="color:#606266;"> 选择你的兴趣方向和想要实现的目的，系统会推荐相关的行业场景，点击标签即可跳转到对应章节。 </font>

{{ item.label }}<font style="color:#909399;">{{ item.desc }}</font>

{{ item.label }}<font style="color:#909399;">{{ item.desc }}</font>

**<font style="color:#409eff;"> 为你推荐 {{ recommendationTopics.length }} 个应用场景 </font>****<font style="color:#909399;"> ({{ currentSelection.interest }} + {{ currentSelection.purpose }}) </font>**

**<font style="color:#303133;">{{ scope.row.title }}</font>**

<font style="color:#909399;">{{ scope.row.desc }}</font>

{{ scope.row.industryName }}

<font style="color:#909399;"> </font><font style="color:#909399;">💡</font><font style="color:#909399;"> 点击表格任意行即可跳转到对应行业章节 </font>

<font style="color:#909399;">💡</font><font style="color:#909399;"> 请选择兴趣方向和实现目的</font><font style="color:#909399;">💡</font><font style="color:#909399;"> 请选择兴趣方向</font><font style="color:#909399;">💡</font><font style="color:#909399;"> 请选择实现目的</font>
